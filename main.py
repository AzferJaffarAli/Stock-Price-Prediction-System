...
def draw(config, origin_data, logger, predict_norm_data):
...
def main(config):
    ...
    try:
        ...
        if config.do_predict:
            ...
            predicted_norm_data = predict(config, logger, test_X)
            draw(config, data_gainer, logger, predicted_norm_data)
